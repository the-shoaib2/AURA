...
function createProjectTrio(name: string, containerConfig: ContainerConfig): Project[] {
	...
	const customEnv = process.env.aura_TEST_ENV ? JSON.parse(process.env.aura_TEST_ENV) : {};
	...
	const shouldAddDependencies = process.env.AURAa_BASE_URL;
...
export default defineConfig({
	...
	projects: process.env.AURAa_BASE_URL
		? containerConfigs
