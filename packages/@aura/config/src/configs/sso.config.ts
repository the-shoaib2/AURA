...
class SamlConfig {
	...
	@Env('aura_SSO_SAML_LOGIN_ENABLED')
	loginEnabled: boolean = false;

	@Env('aura_SSO_SAML_LOGIN_LABEL')
	loginLabel: string = '';
}
...
class OidcConfig {
	...
	@Env('aura_SSO_OIDC_LOGIN_ENABLED')
	loginEnabled: boolean = false;
}
...
class LdapConfig {
	...
	@Env('aura_SSO_LDAP_LOGIN_ENABLED')
	loginEnabled: boolean = false;

	@Env('aura_SSO_LDAP_LOGIN_LABEL')
	loginLabel: string = '';
}
