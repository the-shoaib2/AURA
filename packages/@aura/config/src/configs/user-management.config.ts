...
class SmtpAuth {
	...
	@Env('aura_SMTP_OAUTH_SERVICE_CLIENT')
	serviceClient: string = '';

	/** SMTP OAuth Private Key */
	@Env('aura_SMTP_OAUTH_PRIVATE_KEY')
	privateKey: string = '';
}
...
class EmailConfig {
	/** How to send emails */
	@Env('aura_EMAIL_MODE', emailModeSchema)
	mode: EmailMode = 'smtp';
