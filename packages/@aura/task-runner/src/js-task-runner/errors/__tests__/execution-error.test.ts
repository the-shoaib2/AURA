...
describe('ExecutionError', () => {
    ...
    at JsTaskRunner.executeTask (/aura/packages/aurara/task-runner/dist/js-task-runner/js-task-runner.js:71:26)
    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)
    at async JsTaskRunner.receivedSettings (/aura/packages/aurara/task-runner/dist/task-runner.js:190:26)`;
