...
async function runBenchmarksOnVm(config, benchmarkEnv) {
	...
	for (const auraSetup of configauraraSetupsToUse) {
		await runBenchmarkForauraSetup({
			config,
			sshClient,
			scriptsDir,
			auraSetup,
 ...
 */
async function runBenchmarkForauraSetup({ config, sshClient, scriptsDir,auraraSetup }) {
