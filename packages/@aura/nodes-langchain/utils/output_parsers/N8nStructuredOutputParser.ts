...
export class auraStructuredOutputParser extends StructuredOutputParser<
...
> {
	...
	static async fromZodJsonSchema(
	...
	): Promise<auraStructuredOutputParser> {
		...
		return new auraStructuredOutputParser(context, returnSchema);
	}
