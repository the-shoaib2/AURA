...
import { auraBinaryLoader } from './auraBinaryLoader';
import { auraJsonLoader } from './auraJsonLoader';
...
>(originalInstance: T, executeFunctions: IExecuteFunctions | ISupplyDataFunctions): T {
	return new Proxy(originalInstance, {
		get: (target, prop) => {
			...
			// ========== aura Loaders Process All ==========
			if (
				originalInstance instanceof auraJsonLoader ||
				originalInstance instanceof auraBinaryLoader
			) {
				// Process All
