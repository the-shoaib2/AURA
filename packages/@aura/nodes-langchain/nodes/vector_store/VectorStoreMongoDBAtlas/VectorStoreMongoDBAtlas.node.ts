...
import { type ILoadOptionsFunctions, NodeOperationError, type INodeProperties } from 'aura-workflow';
...
export class VectorStoreMongoDBAtlas extends createVectorStoreNode({
	meta: {
		...
		docsUrl:
			'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodesaurara-nodes-langchain.vectorstoremongodbatlas/',
		credentials: [
			{
				name: 'mongoDb',
				required: true,
