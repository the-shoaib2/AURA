...
import {
	...
	type auraStructuredOutputParser,
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.outputparserautofixing/',
					},
				],
			},
		},
