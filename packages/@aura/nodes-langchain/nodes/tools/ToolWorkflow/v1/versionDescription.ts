...
export const versionDescription: INodeTypeDescription = {
	...
	description: 'Uses another aura workflow as a tool. Allows packaging anyaurara node(s) as a tool.',
	defaults: {
	...
	codex: {
		...
		resources: {
			primaryDocumentation: [
				{
					url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.toolworkflow/',
				},
			],
		},
	},
