...
import { getOptionalOutputParser } from '@utils/output_parsers/auraOutputParser';
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/root-nodesaurara-nodes-langchain.chainllm/',
					},
				],
			},
		},
