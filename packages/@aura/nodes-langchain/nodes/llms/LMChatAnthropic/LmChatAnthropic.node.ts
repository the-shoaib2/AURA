...
export class LmChatAnthropic implements INodeType {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.lmchatanthropic/',
					},
				],
			},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatAnthropic({
			...
			topK: options.topK,
			topP: options.topP,
			callbacks: [new auraLlmTracing(this, { tokensUsageParser })],
