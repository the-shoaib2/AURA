...
export class LmChatGoogleGemini implements INodeType {
		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.lmchatgooglegemini/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatGoogleGenerativeAI({
			...
			safetySettings,
			callbacks: [new auraLlmTracing(this, { errorDescriptionMapper })],
