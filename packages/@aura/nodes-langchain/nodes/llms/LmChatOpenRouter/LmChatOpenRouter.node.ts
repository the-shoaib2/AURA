		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.lmchatopenrouter/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		const model = new ChatOpenAI({
			...
			modelKwargs: options.responseFormat
				...
				: undefined,
			onFailedAttempt: makeauraLlmFailedAttemptHandler(this, openAiFailedAttemptHandler),
		});
