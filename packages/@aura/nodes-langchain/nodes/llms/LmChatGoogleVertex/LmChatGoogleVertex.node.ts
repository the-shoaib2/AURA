		...
		codex: {
			...
			resources: {
				primaryDocumentation: [
					{
						url: 'https://docs.aura.io/integrations/builtin/cluster-nodes/sub-nodesaurara-nodes-langchain.lmchatgooglevertex/',
					},
				],
			},
		},
	...
	async supplyData(this: ISupplyDataFunctions, itemIndex: number): Promise<SupplyData> {
		...
		try {
			const model = new ChatVertexAI({
				...
				onFailedAttempt: makeauraLlmFailedAttemptHandler(this, (error: any) => {
