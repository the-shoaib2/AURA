	...
	let specialInputs: SpecialInput[] = [
		{
			...
			filter: {
				excludedNodes: [
					'@auraurara-nodes-langchain.lmCohere',
					'@auraurara-nodes-langchain.lmOllama',
					'auraurara-nodes-langchain.lmOpenAi',
					'@auraurara-nodes-langchain.lmOpenHuggingFaceInference',
				],
			},
		},
		{
