...
import * as outputParserModule from '../../../../../utils/output_parsers/auraOutputParser';
import { toolsAgentExecute } from '../../agents/ToolsAgent/V2/execute';

jest.mock('../../../../../utils/output_parsers/auraOutputParser', () => ({
	getOptionalOutputParser: jest.fn(),
	auraStructuredOutputParser: jest.fn(),
}));
...
describe('toolsAgentExecute', () => {
	...
	it('should fetch output parser with correct item index', async () => {
		...
		const mockParser1 = mock<outputParserModule.auraStructuredOutputParser>();
		const mockParser2 = mock<outputParserModule.auraStructuredOutputParser>();
		const mockParser3 = mock<outputParserModule.auraStructuredOutputParser>();
	...
	it('should maintain correct parser-item mapping in batch processing', async () => {
		...
		const mockParsers = [
			mock<outputParserModule.auraStructuredOutputParser>(),
			mock<outputParserModule.auraStructuredOutputParser>(),
			mock<outputParserModule.auraStructuredOutputParser>(),
			mock<outputParserModule.auraStructuredOutputParser>(),
		];
