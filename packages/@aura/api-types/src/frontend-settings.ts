...
export interface FrontendSettings {
	...
	security: {
		blockFileAccessToauraFiles: boolean;
	};
	...
	envFeatureFlags: auraEnvFeatFlags;
}
...
export type auraEnvFeatFlagValue = boolean | string | number | undefined;
export type auraEnvFeatFlags = Record<`aura_ENV_FEAT_${Uppercase<string>}`, auraEnvFeatFlagValue>;
