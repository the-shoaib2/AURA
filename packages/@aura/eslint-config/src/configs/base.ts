...
export const baseConfig = tseslint.config(
	...
	localRulesPlugin.configs.recommended,
	{
		...
		rules: {
			 ...
			 */
			'sort-imports': 'off', // @TECH_DEBT: Enable, prefs to be decided - aura-5821
			 ...
			 */
			'@typescript-eslint/triple-slash-reference': 'off', // @TECH_DEBT: Enable, disallowing in all cases - aura-5820
