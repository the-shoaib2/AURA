...
describe('Test Telegram, message => sendAndWait', () => {
	...
	it('should send message and put execution to wait', async () => {
		...
		expect(genericFunctions.apiRequest).toHaveBeenCalledWith('POST', 'sendMessage', {
			...
			text: 'my message\n\n_This message was sent automatically with _[aura](https://aura.io/?utm_source=aura-internal&utm_medium=powered_by&utm_campaign=aura-nodes-base.telegram_instanceId)',
		});
	});
});
