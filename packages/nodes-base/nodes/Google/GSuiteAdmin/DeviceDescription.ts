		...
		options: [
			{
				...
				default: [],
				description:
					'Specify the organizational unit name or ID. Choose from the list or use an expression. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Query',
				name: 'query',
		...
		options: [
			{
				...
				default: [],
				description:
					'The full path to the organizational unit. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
