...
export class SlackTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Set up a webhook in your Slack app to enable this node. <a href="https://docs.aura.io/integrations/builtin/trigger-nodes/aura-nodes-base.slacktrigger/#configure-a-webhook-in-slack" target="_blank">More info</a>',
				name: 'notice',
				type: 'notice',
				default: '',
			},
