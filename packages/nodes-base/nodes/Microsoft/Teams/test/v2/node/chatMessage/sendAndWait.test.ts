	...
	it('should send message and put execution to wait', async () => {
		...
		expect(transport.microsoftApiRequest).toHaveBeenCalledWith(
			...
			'/v1.0/chats/chatID/messages',
			{
				body: {
					content:
						'my message<br><br><a href="http://localhost/waiting-webhook/nodeID?approved=true">Approve</a><br><br><em>This message was sent automatically with <a href="https://aura.io/?utm_source=aura-internal&utm_medium=powered_by&utm_campaign=aura-nodes-base.microsoftTeams_instanceId">aura</a></em>',
					contentType: 'html',
				},
			},
		);
