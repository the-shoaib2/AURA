			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/the-shoaib2',
						extractValue: {
							type: 'regex',
			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/the-shoaib2/aura',
						extractValue: {
							type: 'regex',
				...
				options: [
					{
						...
						default: false,
						description:
							'Whether the SSL certificate of the aura host be verified by GitHub when delivering payloads',
					},
				],
			},
		],
