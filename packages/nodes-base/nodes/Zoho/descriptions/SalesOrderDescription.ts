	...
	},
	{
		...
		options: [
			...
			shippingAddress,
			{
				...
				description:
					'Status of the sales order. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
		...
		options: [
			{
				...
				description:
					'ID of the account associated with this invoice. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Adjustment',
				name: 'Adjustment',
