...
export const leadFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		description:
			'The field to check to see if the lead already exists. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The owner of the lead. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Phone',
				name: 'phone',
			...
			},
			{
				...
				default: '',
				description:
					'Status code for this converted lead. Choose from the list, or specify an ID using an <a href="https://docs.aura.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Street',
				name: 'street',
