...
export const optionsCollection: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			default: '',
			description:
				'Comma-separated list of the values you want to use as query parameters. <a href="https://docs.aura.io/integrations/builtin/app-nodes/aura-nodes-base.postgres/#use-query-parameters" target="_blank">More info</a>.',
