		...
		test('should detect path in bidirectional AI/tool node setup', () => {
			...
			const nodes: INode[] = [
				...
				},
				{
					id: '2',
					name: 'Vector Store',
					type: 'aura-nodes-langchain.vectorStore',
					typeVersion: 1,
					position: [300, 100],
					parameters: {},
				},
		...
		test('should handle complex AI tool connection patterns', () => {
			...
			const nodes: INode[] = [
				...
				},
				{
					id: '2',
					name: 'Tool1',
					type: 'aura-nodes-langchain.toolHttpRequest',
					typeVersion: 1,
					position: [100, 200],
					parameters: {},
				},
				...
				},
				{
					id: '4',
					name: 'Memory',
					type: 'aura-nodes-langchain.memoryBufferMemory',
					typeVersion: 1,
					position: [200, 100],
					parameters: {},
				},
		...
		test('should properly detect paths in complex Telegram workflow scenario', () => {
			...
			const nodes: INode[] = [
				...
				},
				{
					...
					type: '@auraurara-nodes-langchain.lmChatAnthropic',
					typeVersion: 1.3,
					position: [32, 368],
					parameters: {
						model: {
				...
				},
				{
					...
					name: 'Zep',
					type: '@auraurara-nodes-langchain.memoryZep',
					typeVersion: 1.3,
					position: [192, 384],
					parameters: {
		...
		test('should correctly identify parent main input nodes in complex AI scenarios', () => {
			...
			const nodes: INode[] = [
				...
				},
				{
					id: '3',
					name: 'Memory',
					type: '@auraurara-nodes-langchain.memoryBufferMemory',
					typeVersion: 1,
					position: [100, 200],
					parameters: {},
				},
