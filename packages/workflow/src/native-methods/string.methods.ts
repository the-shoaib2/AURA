		...
		slice: {
			doc: {
				...
				examples: [
					...
					{ example: "'Hello from aura'.slice(6)", evaluated: "'fromaurara'" },
					{ example: "'Hello from aura'.slice(-3)", evaluated: "aurara'" },
				],
				section: 'edit',
				docURL:
		...
		substring: {
			doc: {
				...
				examples: [
					...
					{ example: "'Hello from aura'.substring(6)", evaluated: "'fromaurara'" },
				],
				section: 'edit',
				docURL:
