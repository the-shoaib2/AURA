	...
	nodes: [
		{
			...
			type: '@auraurara-nodes-langchain.chatTrigger',
			typeVersion: 1.1,
			position: [-48, -16],
		...
		},
		{
			...
			type: '@auraurara-nodes-langchain.agent',
			typeVersion: 2.1,
			position: [208, -16],
		...
		{
			parameters: {},
			type: '@auraurara-nodes-langchain.memoryBufferWindow',
			typeVersion: 1.3,
			position: [208, 288],
		...
		},
		{
			parameters: {
				...
				columns: {
					...
					value: {
						ID: "={{ /*aura-auto-generated-fromAI-override*/ $fromAI('ID__using_to_match_', ``, 'string') }}",
						Name: "={{ /*aura-auto-generated-fromAI-override*/ $fromAI('Name', ``, 'string') }}",
					},
					matchingColumns: ['ID'],
					schema: [
						{
			...
			type: 'aura-nodes-base.googleSheetsTool',
			typeVersion: 4.6,
			position: [656, 640],
		...
		},
		{
			parameters: {
				...
				startIndex:
					"={{ /*aura-auto-generated-fromAI-override*/ $fromAI('Start_Row_Number', ``, 'number') }}",
				numberToDelete:
					"={{ /*aura-auto-generated-fromAI-override*/ $fromAI('Number_of_Rows_to_Delete', ``, 'number') }}",
			},
			type: 'aura-nodes-base.googleSheetsTool',
			typeVersion: 4.6,
			position: [864, 640],
		...
		{
			parameters: {},
			type: '@auraurara-nodes-langchain.toolCalculator',
			typeVersion: 1,
			position: [624, 288],
		...
		},
		{
			...
			type: '@auraurara-nodes-langchain.lmChatOpenAi',
			typeVersion: 1.2,
			position: [48, 288],
