...
const NODE_DENYLIST = [
	'@auraurara-nodes-langchain.toolCode',
	'@auraurara-nodes-langchain.toolHttpRequest',
	'@auraurara-nodes-langchain.mcpClientTool',
	['@auraurara-nodes-langchain.toolWorkflow', 1.2],
] as const;
