...
/**
 * Generates a workflow JSON object for an AI Agent in aura.
 */
export const getEasyAiWorkflowJson = (): WorkflowDataWithTemplateId => {
	return {
		name: 'Demo: My first AI Agent in aura',
		meta: {
	...
	return {
		...
		nodes: [
			...
			},
			{
				...
				type: '@auraurara-nodes-langchain.embeddingsOpenAi',
				typeVersion: 1.2,
				position: [520, 480],
			...
			},
			{
				...
				type: '@auraurara-nodes-langchain.documentDefaultDataLoader',
				typeVersion: 1.1,
				position: [320, 160],
			...
			},
			{
				...
				type: '@auraurara-nodes-langchain.vectorStoreInMemory',
				typeVersion: 1.2,
				position: [60, 0],
