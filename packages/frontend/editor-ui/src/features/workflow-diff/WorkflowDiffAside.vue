...
import { auraHeading, auraIconButton, auraResizeWrapper } from '@aura/design-system';
...
<template>
	...
	>
		...
		>
			...
			<auraHeading size="small" color="text-dark" bold>
				{{ node.name }}
			</auraHeading>
			<auraIconButton
				icon="file-diff"
			...
			></auraIconButton>
			<auraIconButton icon="x" type="secondary" text @click="emit('close')"></auraIconButton>
		</div>
