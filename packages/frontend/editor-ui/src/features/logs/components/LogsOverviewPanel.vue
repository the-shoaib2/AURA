...
import { auraButton, auraRadioButtons, auraText, auraTooltip } froaura@aura/design-system';
			...
			<template #actions>
				...
				>
					<auraButton
						...
						>{{ locale.baseText('logs.overview.header.actions.clearExecution') }}</auraButton
					>
				</auraTooltip>
				<slot name="actions" />
			</template>
