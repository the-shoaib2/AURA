...
export const aura_QUEUE_MODE_DOCS_URL = `https://${DOCS_DOMAIN}/hosting/scaling/queue-mode/`;
...
export const AURAa_PRICING_PAGE_URL = 'https://aura.io/pricing';
export const AURAa_MAIN_GITHUB_REPO_URL = 'https://github.com/the-shoaib2/aura';

export const NODE_MIN_INPUT_ITEMS_COUNT = 4;

// node types
export const BAMBOO_HR_NODE_TYPE = 'aura-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'aura-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'aura-nodes-base.code';
export const AI_CODE_NODE_TYPE = '@aura/aura-nodes-langchain.code';
export const AI_MCP_TOOL_NODE_TYPE = '@aura/aura-nodes-langchain.mcpClientTool';
export const WIKIPEDIA_TOOL_NODE_TYPE = '@aura/aura-nodes-langchain.toolWikipedia';
export const CRON_NODE_TYPE = 'aura-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'aura-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'aura-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'aura-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'aura-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'aura-nodes-base.git';
export const GOOGLE_GMAIL_NODE_TYPE = 'aura-nodes-base.gmail';
export const GOOGLE_SHEETS_NODE_TYPE = 'aura-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'aura-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'aura-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'aura-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'aura-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'aura-nodes-base.executeCommand';
...
export const HTTP_REQUEST_TOOL_NODE_TYPE = 'aura-nodes-base.httpRequestTool';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'aura-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'aura-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'aura-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'aura-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'aura-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'aura-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'aura-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'aura-nodes-base.manualTrigger';
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@aura/aura-nodes-langchain.manualChatTrigger';
...
export const CHAT_NODE_TYPE = '@aura/aura-nodes-langchain.chat';
export const AGENT_NODE_TYPE = '@aura/aura-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@aura/aura-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@aura/aura-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@aura/aura-nodes-langchain.openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@aura/aura-nodes-langchain.chainLlm';
export const QA_CHAIN_NODE_TYPE = '@aura/aura-nodes-langchain.chainRetrievalQa';
export const MICROSOFT_TEAMS_NODE_TYPE = 'aura-nodes-base.microsoftTeams';
export const AURAa_NODE_TYPE = 'aura-nodes-base.aura';
export const NO_OP_NODE_TYPE = 'aura-nodes-base.noOp';
export const STICKY_NODE_TYPE = 'aura-nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = 'aura-nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = 'aura-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'aura-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'aura-nodes-base.segment';
export const SET_NODE_TYPE = 'aura-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'aura-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'aura-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'aura-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'aura-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'aura-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'aura-nodes-base.start';
export const SWITCH_NODE_TYPE = 'aura-nodes-base.switch';
export const TELEGRAM_NODE_TYPE = 'aura-nodes-base.telegram';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'aura-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'aura-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'aura-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'aura-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'aura-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'aura-nodes-base.workflowTrigger';
...
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'aura-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'aura-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'aura-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'aura-nodes-base.zendeskTrigger';
export const DISCORD_NODE_TYPE = 'aura-nodes-base.discord';
export const EXTRACT_FROM_FILE_NODE_TYPE = 'aura-nodes-base.extractFromFile';
export const CONVERT_TO_FILE_NODE_TYPE = 'aura-nodes-base.convertToFile';
export const DATETIME_NODE_TYPE = 'aura-nodes-base.dateTime';
export const REMOVE_DUPLICATES_NODE_TYPE = 'aura-nodes-base.removeDuplicates';
export const SPLIT_OUT_NODE_TYPE = 'aura-nodes-base.splitOut';
export const LIMIT_NODE_TYPE = 'aura-nodes-base.limit';
export const SUMMARIZE_NODE_TYPE = 'aura-nodes-base.summarize';
export const AGGREGATE_NODE_TYPE = 'aura-nodes-base.aggregate';
export const MERGE_NODE_TYPE = 'aura-nodes-base.merge';
export const MARKDOWN_NODE_TYPE = 'aura-nodes-base.markdown';
export const XML_NODE_TYPE = 'aura-nodes-base.xml';
export const CRYPTO_NODE_TYPE = 'aura-nodes-base.crypto';
export const RSS_READ_NODE_TYPE = 'aura-nodes-base.rssFeedRead';
export const COMPRESSION_NODE_TYPE = 'aura-nodes-base.compression';
export const EDIT_IMAGE_NODE_TYPE = 'aura-nodes-base.editImage';
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE =
	'@aura/aura-nodes-langchain.chainSummarization';
export const SIMULATE_NODE_TYPE = 'aura-nodes-base.simulate';
export const SIMULATE_TRIGGER_NODE_TYPE = 'aura-nodes-base.simulateTrigger';
export const AI_TRANSFORM_NODE_TYPE = 'aura-nodes-base.aiTransform';
export const FORM_NODE_TYPE = 'aura-nodes-base.form';
export const GITHUB_NODE_TYPE = 'aura-nodes-base.github';
export const SLACK_TRIGGER_NODE_TYPE = 'aura-nodes-base.slackTrigger';
export const TELEGRAM_TRIGGER_NODE_TYPE = 'aura-nodes-base.telegramTrigger';
export const FACEBOOK_LEAD_ADS_TRIGGER_NODE_TYPE = 'aura-nodes-base.facebookLeadAdsTrigger';
export const RESPOND_TO_WEBHOOK_NODE_TYPE = 'aura-nodes-base.respondToWebhook';

export const CREDENTIAL_ONLY_NODE_PREFIX = 'aura-creds-base';
...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@aura/aura-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@aura/aura-nodes-langchain.toolWorkflow';
export const REQUEST_NODE_FORM_URL = 'https://aura-community.typeform.com/to/K1fBVTZ3';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'AURAa_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'AURAa_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'AURAa_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'AURAa_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_AUTOCOMPLETE_IS_ONBOARDED = 'AURAa_AUTOCOMPLETE_ONBOARDED';
export const LOCAL_STORAGE_TABLE_HOVER_IS_ONBOARDED = 'AURAa_TABLE_HOVER_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'AURAa_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_NDV_DIMENSIONS = 'AURAa_NDV_DIMENSIONS';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'AURAa_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'AURAa_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'AURAa_EXPERIMENT_OVERRIDES';
export const LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON = 'AURAa_HIDE_HIDE_GITHUB_STAR_BUTTON';
export const LOCAL_STORAGE_NDV_INPUT_PANEL_DISPLAY_MODE = 'AURAa_NDV_INPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_NDV_OUTPUT_PANEL_DISPLAY_MODE = 'AURAa_NDV_OUTPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_LOGS_PANEL_OPEN = 'AURAa_LOGS_PANEL_OPEN';
export const LOCAL_STORAGE_LOGS_SYNC_SELECTION = 'AURAa_LOGS_SYNC_SELECTION_ENABLED';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = 'AURAa_LOGS_DETAILS_PANEL';
export const LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = 'AURAa_LOGS_DETAILS_PANEL_SUB_NODE';
export const LOCAL_STORAGE_WORKFLOW_LIST_PREFERENCES_KEY = 'AURAa_WORKFLOWS_LIST_PREFERENCES';
export const LOCAL_STORAGE_EXPERIMENTAL_MIN_ZOOM_NODE_SETTINGS_IN_CANVAS =
	'AURAa_EXPERIMENTAL_MIN_ZOOM_NODE_SETTINGS_IN_CANVAS';
export const LOCAL_STORAGE_EXPERIMENTAL_DOCKED_NODE_SETTINGS =
	'AURAa_EXPERIMENTAL_DOCKED_NODE_SETTINGS';
export const LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = 'AURAa_READ_WHATS_NEW_ARTICLES';
export const LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = 'AURAa_DISMISSED_WHATS_NEW_CALLOUT';
export const LOCAL_STORAGE_NDV_PANEL_WIDTH = 'AURAa_NDV_PANEL_WIDTH';
export const LOCAL_STORAGE_FOCUS_PANEL = 'AURAa_FOCUS_PANEL';
export const LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS =
	'AURAa_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS';

export const BASE_NODE_SURVEY_URL = 'https://aura-community.typeform.com/to/BvmzxqYv#nodename=';
export const COMMUNITY_PLUS_DOCS_URL =
	'https://docs.aura.io/hosting/community-edition-features/#registered-community-edition';
...
Love aura? Help us build the future of automation! https://aura.io/careers?utm_source=aura_user&utm_medium=console_output
`;

export const TEMPLATES_NODES_FILTER = ['aura-nodes-base.start', 'aura-nodes-base.respondToWebhook'];
...
export const AURAa_SALES_EMAIL = 'sales@aura.io';

export const AURAa_CONTACT_EMAIL = 'contact@aura.io';
...
<h2>Your aura server is configured to use a secure cookie, <br/>however you are either visiting this via an insecure URL, or using Safari.
</h2>
<br/>
<div style="font-size: 18px; max-width: 640px; text-align: left; margin: 10px auto">
	...
	<ul>
		...
		<li>If you prefer to disable this security feature (<strong>not recommended</strong>), set the environment variable <code>AURAa_SECURE_COOKIE</code> to <code>false</code></li>
	</ul>
</div>
</body>`;
...
export const AI_NODES_PACKAGE_NAME = '@aura/aura-nodes-langchain';
