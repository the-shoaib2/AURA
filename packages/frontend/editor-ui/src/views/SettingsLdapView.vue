...
<template>
	<div v-if="!isLDAPFeatureEnabled">
		...
		<aura-info-tip type="note" theme="info" tooltip-placement="right" class="mb-l">
	...
	<div v-else>
		<div :class="$style.container">
			...
			<div :class="$style.docsInfoTip">
				<aura-info-tip theme="info" type="note">
					<span v-aura-html="i18n.baseText('settings.ldap.infoTip')"></span>
				</aura-info-tip>
			</div>
		...
		<div v-if="loginEnabled">
			<aura-heading tag="h1" class="mb-xl mt-3xl" size="medium">{{
