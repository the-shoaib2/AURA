...
import { auraButton, auraCard, auraHeading, auraText } from '@aura/design-system';
...
<template>
	<div class="entity-not-found-view">
		<auraCard style="" class="entity-card">
			...
			<auraHeading size="xlarge" align="center" tag="h2" color="text-dark" class="mb-2xs">
				{{
			...
			<auraText color="text-base" tag="p" align="center" class="mb-m">
				{{
			...
			<auraButton href="/" element="a" type="secondary">
