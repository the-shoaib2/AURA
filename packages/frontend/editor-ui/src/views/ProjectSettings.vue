...
const nameInput = ref<InstanceType<typeof auraFormInput> | null>(null);
...
// So that auraUsersList has access to the full user data
			...
			<fieldset :class="$style.buttons">
				<div>
					...
					<auraButton
						...
						>{{ i18n.baseText('projects.settings.button.cancel') }}</auraButton
					>
				</div>
				<auraButton
					...
					>{{ i18n.baseText('projects.settings.button.save') }}</auraButton
				>
			</fieldset>
			<fieldset>
				<hr class="mb-2xl" />
				...
				<auraButton
					...
					>{{ i18n.baseText('projects.settings.danger.deleteProject') }}</auraButton
				>
			</fieldset>
		</form>
		<ProjectDeleteDialog
