...
const testTemplate1 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			mockTemplateNode('IMAP Email', 'aura-nodes-base.emailReadImap'),
			mockTemplateNode('Nextcloud', 'aura-nodes-base.nextCloud'),
		],
	},
	full: true,
});
...
const testTemplate2 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			{
				...mockTemplateNode('Telegram', 'aura-nodes-base.telegram'),
				credentials: {
			...
			expect(setupTemplateStore.credentialUsages).toEqual([
				{
					...
					credentialType: 'imap',
					key: 'imap-',
					nodeTypeName: 'aura-nodes-base.emailReadImap',
				...
				},
				{
					...
					key: 'nextCloudApi-',
					nodeTypeName: 'aura-nodes-base.nextCloud',
