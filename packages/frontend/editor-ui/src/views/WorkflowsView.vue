...
import type { PathItem } from '@aura/design-system/components/auraBreadcrumbs/Breadcrumbs.vue';
	...
	>
		...
		<template #breadcrumbs>
			<div v-if="breadcrumbsLoading" :class="$style['breadcrumbs-loading']">
				<aura-loading :loading="breadcrumbsLoading" :rows="1" variant="p" />
			</div>
			<div
		...
		<template #empty>
			...
			<div v-else>
				<div class="text-center mt-s" data-test-id="list-empty-state">
					<auraHeading tag="h2" size="xlarge" class="mb-2xs">
						{{
					...
					<auraText size="large" color="text-base">
					...
					>
						<div :class="$style.emptyStateCardContent">
							<auraIcon
								...
								:stroke-width="1.5"
							/>
							<auraText size="large" class="mt-xs">
					...
					>
						<div :class="$style.emptyStateCardContent">
							<auraIcon
								...
								color="foreground-dark"
							/>
							<auraText size="large" class="mt-xs pl-2xs pr-2xs">
