...
import { CREDENTIAL_EMPTY_VALUE, isResourceLocatorValue, NodeHelpers } from 'aura-workflow';
...
import { auraIcon, auraInput, auraInputNumber, auraOption, auraSelect } fraura'@aura/design-system';
...
const inputField = ref<InstanceType<typeof auraInput | typeof auraSelect> | HTMLElement>();
...
onMounted(() => {
	...
	void externalHooks.run('parameterInput.mount', {
		...
		inputFieldRef: inputField.value as InstanceType<typeof auraInput>,
	});
});
