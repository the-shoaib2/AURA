...
import { auraIcon, auraRadioButtons, auraText, auraTooltip } froaura@aura/design-system';
import {
...
<template>
	...
	>
		...
		<template #node-not-run>
			...
			>
				<template v-if="isNDVV2">
					...
					>
						<template #icon>
							<auraIcon icon="arrow-right-to-line" size="xlarge" />
						</template>
				...
				<template v-else>
					...
					<template v-else>
						...
						<auraText tag="div" color="text-dark" size="medium">
							<I18nT tag="span" keypath="ndv.input.rootNodeHasNotRun.description" scope="global">
								<template #link>
									<a
										href="#"
					...
					<auraText v-if="!readOnly" tag="div" size="small">
		...
		<template #node-waiting>
			...
			<auraText vaurara-html="waitingMessage"></auraText>
		</template>
