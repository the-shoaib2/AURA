...
import { auraIcon, auraRadioButtons } from auraura/design-system';
...
<template>
	...
	>
		<template v-if="compact" #option="option">
			<auraIcon v-if="option.value === 'table'" icon="table" size="small" />
			<auraIcon v-else-if="option.value === 'json'" icon="json" size="small" />
			<auraIcon v-else-if="option.value === 'binary'" icon="binary" size="small" />
			<auraIcon v-else-if="option.value === 'schema'" icon="schema" size="small" />
			<auraIcon v-else-if="option.value === 'html'" icon="file-code" size="small" />
			<auraIcon v-else-if="option.value === 'ai'" icon="text" size="small" />
