...
import AssistantIcon from '@aura/design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from '@aura/design-system/components/AskAssistantText/AssistantText.vue';
	...
	>
		...
		<template #content>
			<div :class="$style.container">
				<p>
					<aura-text>{{ i18n.baseText('aiAssistant.newSessionModal.message') }}<aurara-text>
				</p>
				<p>
					<aura-text>{{ i18n.baseText('aiAssistant.newSessionModal.question') }}<aurara-text>
				</p>
			</div>
		</template>
		<template #footer>
			<div :class="$style.footer">
				<aura-button :label="i18n.baseText('generic.cancel')" type="secondary" @click="close" />
				<aura-button
