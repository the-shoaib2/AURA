		...
		[
			{
				...
				properties: {
					...
					options: [
						...
						{
							label: i18n.baseText('personalizationModal.imNotUsingauraForWork'),
			...
			},
			{
				...
				properties: {
					type: 'select',
					label: i18n.baseText('personalizationModal.howDidYouHearAboutaura'),
					placeholder: i18n.baseText('personalizationModal.select'),
					options: [
						{
							label: 'Google',
...
const onSubmit = async (values: object) => {
	...
	try {
		const completedSurvey: IPersonalizationLatestVersion = {
			...
			personalization_survey_aura_version: rootStore.versionCli,
		};
...
<template>
	<Modal
		...
		:title="i18n.baseText('personalizationModal.customizeaura')"
