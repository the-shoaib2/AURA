	...
	<div v-if="communityNodeDetails" :class="$style.container">
		<div :class="$style.header">
			<div :class="$style.title">
				...
				<auraTooltip v-if="communityNodeDetails.official" placement="bottom" :show-after="500">
					<template #content>
						{{
			...
			<div>
				<div v-if="communityNodeDetails.installed" :class="$style.installed">
					<auraIcon v-if="!communityNodeDetails.official" :class="$style.installedIcon" icon="box" />
					<auraText color="text-light" size="small" bold>
