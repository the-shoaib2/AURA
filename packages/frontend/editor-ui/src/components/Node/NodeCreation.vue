...
<template>
	<div v-if="!createNodeActive" :class="$style.nodeButtonsWrapper">
		...
		<KeyboardShortcutTooltip
			...
			placement="left"
		>
			<aura-icon-button type="tertiary" size="large" icon="panel-right" @click="toggleFocusPanel" />
		</KeyboardShortcutTooltip>
		<aura-tooltip v-if="assistantStore.canShowAssistantButtonsOnCanvas" placement="left">
