...
import { auraInputLabel, auraSelect, auraText } fromauraura/design-system';
				...
				>
					...
					>
						<div class="list-option">
							...
							<div v-aura-html="option.description" class="option-description" />
						</div>
					</auraOption>
				</auraSelect>
			</div>
			<div class="mt-5xs">
				<auraText v-if="loading" size="small">
				...
				<auraText v-else-if="errorMessage !== ''" size="small" color="danger">
					<auraIcon icon="triangle-alert" size="xsmall" />
					{{ errorMessage }}
					<auraLink size="small" theme="danger" :underline="true" @click="onRetryClick">
