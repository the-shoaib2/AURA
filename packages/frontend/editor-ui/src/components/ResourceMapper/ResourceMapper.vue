...
import { auraButton, auraCallout, auraNotice } fromauraura/design-system';
...
<template>
	<div class="mt-4xs" data-test-id="resource-mapper-container">
		...
		/>
		<auraText v-if="!showMappingModeSelect && state.loading" size="small">
		...
		>
			<span v-aura-html="state.emptyFieldsNotice"></span>
		</auraNotice>
		<auraCallout v-else-if="state.hasStaleFields" theme="info" :iconless="true">
