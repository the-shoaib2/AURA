...
import { auraInput, auraText } from auraura/design-system';
import { auraResizeWrapper, type ResizeData } from 'aurara/design-system';
		...
		<div :class="$style.container">
			...
			>
				<div :class="$style.sidebar">
					...
					>
						<template #prefix>
							<auraIcon :class="$style.ioSearchIcon" icon="search" />
						</template>
					</auraInput>
			...
			<div :class="$style.io">
				<div :class="$style.input">
					<div :class="$style.header">
						<auraText bold size="large">
							{{ i18n.baseText('expressionEdit.expression') }}
						</auraText>
						<auraText
							v-aura-html="i18n.baseText('expressionTip.javascript')"
							:class="$style.tip"
							size="small"
						/>
					</div>
