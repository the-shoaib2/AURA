...
<template>
	...
	>
		<div :class="$style.heading">
			<aura-heading tag="h2" size="medium" color="text-dark">
		...
		>
			...
			>
				<aura-text color="text-base" size="medium" align="center">
