...
<template>
	...
	>
		...
		>
			<aura-badge v-if="customDataLength > 0" :class="$style.badge" theme="primary">
			...
			>
				<div :class="$style.section">
					<div :class="$style.heading">
						<aura-heading tag="h3" size="small" color="text-dark">
					...
					>
						...
						>
							<aura-text :class="$style.key" size="small" color="text-base">
								{{ attr }}
							</aura-text>
							<aura-text :class="$style.value" size="small" color="text-base">
					...
					>
						<aura-text color="text-base" size="small" align="center">
							<span v-aura-html="i18n.baseText('executionAnnotationView.data.notFound')" />
						</aura-text>
					</div>
				</div>
			</div>
