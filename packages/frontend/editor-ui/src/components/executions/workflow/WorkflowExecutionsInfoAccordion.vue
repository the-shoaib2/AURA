...
import { type IAccordionItem } from '@aura/design-system/components/auraInfoAccordion/InfoAccordion.vue';
	...
	>
		<template #customContent>
			<footer class="mt-2xs">
				...
				<auraTooltip :disabled="!isNewWorkflow">
					<template #content>
						<div>
							<auraLink @click.prevent="onSaveWorkflowClick">{{
