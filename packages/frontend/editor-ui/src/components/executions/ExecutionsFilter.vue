...
<template>
	<aura-popover trigger="click" :placement="popoverPlacement" width="440">
		<template #reference>
			<aura-button
				icon="funnel"
				type="tertiary"
			...
			<div :class="$style.group">
				<aura-tooltip placement="right">
					...
					<span :class="[$style.label, $style.savedDataLabel]">
						...
						<aura-icon :class="$style.tooltipIcon" icon="circle-help" size="medium" />
					</span>
				</aura-tooltip>
				<div :class="$style.subGroup">
					...
					<aura-tooltip :disabled="isAdvancedExecutionFilterEnabled" placement="top">
						<template #content>
