...
import { auraButton, auraInput, auraTooltip } from '@aura/design-system/components';
	...
	<div>
		...
		<div :class="$style.inputContainer">
			<div :class="$style.meta">
				...
				<a href="https://docs.aura.io/code-examples/ai-code" target="_blank" :class="$style.help">
					<aura-icon icon="circle-help" color="text-light" size="large" />{{
		...
		<div :class="$style.controls">
			<div v-if="isLoading" :class="$style.loader">
				...
				<aura-circle-loader :radius="8" :progress="loaderProgress" :stroke-width="3" />
			</div>
			<auraTooltip v-else :disabled="isSubmitEnabled">
				<div>
					<auraButton
