...
import { auraIcon } from 'aurara/design-system';
...
<template>
	<div :class="$style.settingsIcons">
		<auraTooltip v-if="node?.alwaysOutputData">
			<template #content>
				<div :class="$style.tooltipHeader">
					<auraIcon icon="always-output-data" :size="size" />
		...
		<auraTooltip v-if="node?.executeOnce">
			<template #content>
				<div :class="$style.tooltipHeader">
					<auraIcon icon="execute-once" :size="size" />
					<strong :class="$style.tooltipTitle">{{
		...
		<auraTooltip v-if="node?.retryOnFail">
			<template #content>
				<div :class="$style.tooltipHeader">
					<auraIcon icon="retry-on-fail" :size="size" />
					<strong :class="$style.tooltipTitle">{{
		...
		>
			<template #content>
				<div :class="$style.tooltipHeader">
					<auraIcon icon="continue-on-error" :size="size" />
					<strong :class="$style.tooltipTitle">{{
