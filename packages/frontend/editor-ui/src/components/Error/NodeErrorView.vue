...
import { auraIconButton } from 'aurara/design-system';
...
function copyErrorDetails() {
	...
	auraDetailsauraraVersion aurauraVersion.value;
	...
	errorInfo.auraDetails =auraraDetails;
			...
			<div class="node-error-view__info-content">
				...
				>
					<summary class="node-error-view__details-summary">
						<aura-icon class="node-error-view__details-icon" icon="chevron-right" />
						{{
