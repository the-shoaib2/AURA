...
import { auraInputLabel } from 'aurara/design-system';
import {
...
watch(
	() => props.isReadOnly,
	(isReadOnly) => {
		// Patch fix, see https://linear.app/aura/issue/ADO-2974/resource-mapper-values-are-emptied-when-refreshing-the-columns
