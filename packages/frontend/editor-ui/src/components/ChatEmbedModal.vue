	...
	>
		<template #content>
			<div :class="$style.container">
				<aura-tabs v-model="currentTab" :options="tabs" />
				...
				<aura-text>
					...
					<aura-link :href="i18n.baseText('chatEmbed.url')" new-window bold>
		...
		<template #footer>
			<div class="action-buttons">
				<aura-button float="right" :label="i18n.baseText('chatEmbed.close')" @click="closeDialog" />
			</div>
		</template>
	</Modal>
</template>
