...
import { auraText, auraInput, auraResizeWrapper, auraInfoTip } from '@aura/design-system';
...
const inputField = ref<InstanceType<typeof auraInput> | HTMLElement>();
				...
				<div v-if="resolvedParameter" :class="$style.content">
					<div :class="$style.tabHeader">
						<div :class="$style.tabHeaderText">
							...
							<auraText color="text-base" size="xsmall">{{ resolvedParameter.node.name }}</auraText>
						</div>
					...
					<div :class="$style.emptyText">
						<div :class="$style.focusParameterWrapper">
							<div :class="$style.iconWrapper">
								<auraIcon :class="$style.forceHover" icon="panel-right" size="medium" />
								<auraIcon
							...
							<auraIcon icon="ellipsis-vertical" size="small" color="text-base" />
							<auraRadioButtons
								size="small"
						...
						<auraText color="text-base" size="medium" :bold="true">
							{{ locale.baseText('nodeView.focusPanel.noParameters.title') }}
						</auraText>
						<auraText color="text-base" size="small">
