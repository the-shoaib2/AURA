...
import { auraText, auraButton, auraCallout } fromauraura/design-system';
		...
		<div :class="$style.steps">
			...
			<div :class="[$style.step, $style.completed]">
				...
				<div v-if="activeStepIndex === 0" :class="$style.stepContent">
					<ul :class="$style.bulletPoints">
						<li>
							<auraText size="small" color="text-base">
			...
			<div :class="$style.step">
				...
				<div v-if="activeStepIndex === 2" :class="$style.stepContent">
					...
					<auraCallout v-else theme="warning" iconless>
					...
					<div :class="$style.actionButton">
						...
						<auraButton v-else size="small" @click="onSeePlans">
					...
					>
						<auraText size="xsmall" color="text-base">
