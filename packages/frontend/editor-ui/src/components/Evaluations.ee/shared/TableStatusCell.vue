...
import auraTooltip from '@aura/design-system/components/auraTooltip';
...
<template>
	...
	>
		<template #content>
			<div v-aura-html="getErrorTooltip(column, row)" />
		</template>
		<auraBadge :theme="statusThemeMap[row.status]" class="mr-4xs">
