		...
		<template #content>
			<div>
				...
				<div v-else :class="$style.content">
					<div>
						<aura-text color="text-base">{{ folderContentWarningMessage }}<aurara-text>
					</div>
					<el-radio
						v-model="operation"
					...
					>
						<aura-text color="text-dark">{{ i18n.baseText('folders.delete.action') }}<aurara-text>
					</el-radio>
					<div
