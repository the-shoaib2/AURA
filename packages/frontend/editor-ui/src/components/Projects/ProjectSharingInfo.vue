...
import { isIconOrEmoji } from '@aura/design-system/components/auraIconPicker/types';
...
<template>
	<div :class="$style.projectInfo" data-test-id="project-sharing-info">
		<div>
			...
			<auraAvatar v-else :first-name="processedName.firstName" :last-name="processedName.lastName" />
