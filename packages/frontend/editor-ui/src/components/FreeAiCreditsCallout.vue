...
import { auraCallout, auraText } from '@aura/design-system';

const LANGCHAIN_NODES_PREFIX = '@aura/aura-nodes-langchain.';

const aura_NODES_PREFIX = '@aura/aura-nodes.';
...
<template>
	...
	<auraCallout v-else-if="showSuccessCallout" theme="success" icon="circle-check" class="mt-xs">
		<auraText size="small">
			{{
