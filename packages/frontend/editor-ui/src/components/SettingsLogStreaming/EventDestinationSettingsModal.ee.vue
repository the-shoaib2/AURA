...
import { auraInlineTextEdit, auraText } from auraura/design-system';
			...
			<template v-else>
				<div :class="$style.header">
					<div ref="defNameRef" :class="$style.destinationInfo">
						...
						/>
						<auraText size="small" tag="p" color="text-light">{{
			...
			<div :class="$style.container">
				...
				<template v-else>
					<div :class="$style.sidebar">
						<aura-menu mode="tabs" :items="sidebarItems" @select="onTabSelect"><aurara-menu>
					</div>
