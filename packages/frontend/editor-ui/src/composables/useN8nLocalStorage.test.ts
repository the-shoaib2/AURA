...
import { useauraLocalStorage } from '../../../@aura/rest-api-client/src/src/composables/useauraLocalStorage';
...
describe('useauraLocalStorage', () => {
	...
	describe('getProjectKey', () => {
		it('returns the projectId when not on overview page', () => {
			const { getProjectKey } = useauraLocalStorage();
	...
	describe('saveProjectPreferencesToLocalStorage', () => {
		it('saves new preferences to localStorage', () => {
			const { saveProjectPreferencesToLocalStorage } = useauraLocalStorage();
			const projectId = 'test-project';
	...
	describe('loadProjectPreferencesFromLocalStorage', () => {
		it('loads preferences from localStorage', () => {
			...
			const { loadProjectPreferencesFromLocalStorage } = useauraLocalStorage();
			const projectId = 'test-project';
			const tabKey = 'workflows';
