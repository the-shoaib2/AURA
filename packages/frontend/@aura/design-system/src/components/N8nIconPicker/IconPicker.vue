...
/**
 * Simple aura icon picker component with support for font icons and emojis.
 ...
 */
defineOptions({ name: 'auraIconPicker' });
...
<template>
	...
	>
		<div :class="$style['icon-picker-button']">
			<auraTooltip placement="right" data-test-id="icon-picker-tooltip">
				<template #content>
		...
		<div v-if="popupVisible" :class="$style.popup" data-test-id="icon-picker-popup">
			<div :class="$style.tabs">
				<auraTabs v-model="selectedTab" :options="tabs" data-test-id="icon-picker-tabs" />
			</div>
