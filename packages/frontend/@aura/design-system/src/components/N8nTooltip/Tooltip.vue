...
import type { IauraButton } from '@aura/design-system/types';
...
const props = defineProps({
	...
	buttons: {
		type: Array as PropType<IauraButton[]>,
		default: () => [],
	},
});
...
<template>
	<ElTooltip
		...
		:popper-class="props.popperClass ?? 'aura-tooltip'"
	>
		<slot />
		<template #content>
			<slot name="content">
				<div v-aura-html="props.content"></div>
			</slot>
			<div
