...
WithYoutubeEmbed.args = {
	content:
		"## I'm markdown \n**Please check** this out. [Guide](https://docs.aura.io/workflows/sticky-notes/)\n@[youtube](ZCuL2e4zC_4)\n",
	loading: false,
};
