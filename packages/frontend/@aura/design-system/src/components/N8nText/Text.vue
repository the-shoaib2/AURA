...
import type { TextAlign, TextColor, TextSize } from '@aura/design-system/types/text';
...
<template>
	<component :is="tag" :class="['aura-text', ...classes]" v-bind="$attrs">
		<slot></slot>
	</component>
</template>
