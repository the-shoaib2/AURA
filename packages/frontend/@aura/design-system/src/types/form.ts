import type { auraLocaleTranslateFnOptions } from '@aura/design-system/types/i18n';
...
export type RuleGroup = {
	...
	defaultError?: { messageKey: string; options?: auraLocaleTranslateFnOptions };
};
...
export type IValidator<T = unknown> = {
	validate: (
		...
		| false
		| { message: string; options?: auraLocaleTranslateFnOptions }
		| { messageKey: string; options?: auraLocaleTranslateFnOptions }
		| null;
};
