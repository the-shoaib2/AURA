# aura Chat
This is an embeddable Chat widget for aura. It allows the execution of AI-Powered Workflows through a Chat window.

**Windowed Example**
![aura Chat Windowed](https://raw.githubusercontent.com/the-shoaib2/aura/master/packages/frontend/%40aura/chat/resources/images/windowed.png)

**Fullscreen Example**
![aura Chat Fullscreen](https://raw.githubusercontent.com/the-shoaib2/aura/master/packages/frontend/%40aura/chat/resources/images/fullscreen.png)

## Prerequisites
Create a aura workflow which you want to execute via chat. The workflow has to be triggered using a **Chat Trigger** node.
...
[See example workflow](https://github.com/the-shoaib2/aura/blob/master/packages/%40aura/chat/resources/workflow.json)

To use streaming responses, you need to enable the **Streaming response** response mode in the **Chat Trigger** node.
[See example workflow with streaming](https://github.com/the-shoaib2/aura/blob/master/packages/%40aura/chat/resources/workflow-streaming.json)

> Make sure the workflow is **Active.**

### How it works
Each Chat request is sent to the aura Webhook endpoint, which then sends back a response.
...
### b. Import Embed
Install and save aura Chat as a production dependency.
...
- **Required**: `true`
- **Examples**:
	- `https://yourname.app.aura.cloud/webhook/513107b3-6f3a-4a1e-af21-659f0ed14183`
	- `http://localhost:5678/webhook/513107b3-6f3a-4a1e-af21-659f0ed14183`
- **Description**: The URL of the aura Webhook endpoint. Should be the production URL.
...
- Type: boolean
- Default: false
- Description: Whether to enable streaming responses from the aura workflow. If set to `true`, the chat will display responses as they are being generated, providing a more interactive experience. For this to work the workflow must be configured as well to return streaming responses.
