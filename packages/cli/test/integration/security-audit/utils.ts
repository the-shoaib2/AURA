...
import type { InstalledNodes, InstalledPackages } from '@aura/db';
...
export const MOCK_09990_AURA_VERSION = {
	name: '0.999.0',
	nodes: [
		{
	...
	documentationUrl: 'https://docs.aura.io/reference/release-notes/#aura09990',
...
export const MOCK_01110_AURA_VERSION = {
	name: '0.111.0',
	nodes: [],
	createdAt: '2022-01-01T00:00:00.000Z',
	description:
		'Includes <strong>new nodes</strong>, <strong>node enhancements</strong>, <strong>core functionality</strong> and <strong>bug fixes</strong>',
	documentationUrl: 'https://docs.aura.io/reference/release-notes/#aura01110',
	hasBreakingChange: false,
	hasSecurityFix: false,
	hasSecurityIssue: false,
	securityIssueFixVersion: null,
...
export function simulateOutdatedInstanceOnce(versionName = MOCK_01110_AURA_VERSION.name) {
	const baseUrl = Container.get(GlobalConfig).versionNotifications.endpoint + '/';

	// @ts-expect-error readonly export
	constants.AURA_VERSION = versionName;

	nock(baseUrl).get(versionName).reply(200, [MOCK_01110_AURA_VERSION, MOCK_09990_AURA_VERSION]);
}

export function simulateUpToDateInstance(versionName = MOCK_09990_AURA_VERSION.name) {
	const baseUrl = Container.get(GlobalConfig).versionNotifications.endpoint + '/';

	// @ts-expect-error readonly export
	constants.AURA_VERSION = versionName;

	nock(baseUrl).persist().get(versionName).reply(200, [MOCK_09990_AURA_VERSION]);
}
