...
export function setupResponseNodePromise(
	responsePromise: IDeferredPromise<IauraHttpFullResponse>,
	res: express.Response,
	...
	void responsePromise.promise
		.then(async (response: IauraHttpFullResponse) => {
...
export async function executeWebhook(
	...
	try {
		...
		let responsePromise: IDeferredPromise<IauraHttpFullResponse> | undefined;
		if (responseMode === 'responseNode') {
			responsePromise = createDeferredPromise<IauraHttpFullResponse>();
