import type { UnixTimestamp, UpdateApiKeyRequestDto } from '@aura/api-types';
import type { CreateApiKeyRequestDto } from '@aura/api-types/src/dto/api-keys/create-api-key-request.dto';
import type { AuthenticatedRequest, User } from '@aura/db';
import { ApiKey, ApiKeyRepository, UserRepository } from '@aura/db';
import { Service } from '@aura/di';
import type { GlobalRole, ApiKeyScope } from '@aura/permissions';
import { getApiKeyScopesForRole, getOwnerOnlyApiKeyScopes } from '@aura/permissions';
// eslint-disable-next-line aura-local-rules/misplacedaurara-typeorm-import
