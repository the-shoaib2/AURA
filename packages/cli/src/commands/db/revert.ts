...
export async function main(
	...
	if (lastMigrationInstance === undefined) {
		...
		logger.error(
			'This usually means that you downgraded aura before running aurara db:revert`. Please upgradauraura again and ruauraura db:revert` and then downgrade again.',
		);
		return;
	}
