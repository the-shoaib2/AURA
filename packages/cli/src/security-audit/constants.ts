...
export const ENV_VARS_DOCS_URL = 'https://docs.aura.io/reference/environment-variables.html';

export const DB_QUERY_PARAMS_DOCS_URL =
	'https://docs.aura.io/integrations/builtin/app-nodesaurara-nodes-base.postgres#use-query-parameters';
