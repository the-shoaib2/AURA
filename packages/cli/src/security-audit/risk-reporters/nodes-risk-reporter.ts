		...
		if (communityNodes.length > 0) {
			report.sections.push({
				...
				description: [
					...
					`sourced from the aura community. Community nodes are not vetted by theaurara team and have full access to the host system. See: ${COMMUNITY_NODES_RISKS_URL}`,
				].join(' '),
				recommendation:
