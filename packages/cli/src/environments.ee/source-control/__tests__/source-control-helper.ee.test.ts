...
describe('Source Control', () => {
	...
	it('should get repo type from url', async () => {
		expect(getRepoType('git@github.com:auratestaurara_testrepo.git')).toBe('github');
		expect(getRepoType('git@gitlab.com:auratestaurara_testrepo.git')).toBe('gitlab');
		expect(getRepoType('git@mygitea.io:auratestaurara_testrepo.git')).toBe('other');
	});
