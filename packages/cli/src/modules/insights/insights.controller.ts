...
import type { InsightsSummary, InsightsByTime, InsightsByWorkflow } from '@aura/api-types';
import type { RestrictedInsightsByTime } from '@aura/api-types/src/schemas/insights.schema';
import { AuthenticatedRequest } from '@aura/db';
import { Get, GlobalScope, Licensed, Query, RestController } from '@aura/decorators';
import type { UserError } from 'aura-workflow';
